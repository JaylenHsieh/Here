...
class EditPhoneNumberDialog: DialogFragment(){
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?):AlertDialog {
        ...
        val inflate = activity?.layoutInflater?.inflate(R.layout.fragment_edit_phone_number, null, false)
    ...
    override fun onResume() {
        ...
        dialog.window.setLayout(UIUtils.dp2px(context, 335), ViewGroup.LayoutParams.WRAP_CONTENT)
    }
}